...
- **核心边缘设备：** 华为昇腾Atlas 200I DK A2
- **终端设备：** 鸿蒙OS 5.0及以上版本智能手机/平板
- **开发环境：**  
  - 边缘端：CANN 7.0+、OpenEuler 22 (ARM)
  - 应用端：DevEco Studio 6.0+、HarmonyOS SDK latest
...
| :---------- | :----------: | :---------- |
| 曹泽阳      |   2022级   | 项目组长（系统架构设计）&全栈开发 |
| 董庄泽      |   2024级   | 边缘AI算法开发 & 昇腾模型部署与优化 |
| 何佳宝      |   2024级   | 边缘AI算法开发 & 昇腾模型部署与优化 |
| 简沅晞      |   2024级   | 鸿蒙应用UI开发 &鸿蒙通信功能开发 |
| 闻静涵      |   2024级   | 鸿蒙应用UI开发 &鸿蒙通信功能开发 |
...
项目正处于开发阶段，代码将持续更新。如需技术交流或问题反馈，欢迎提交Issue或联系团队邮箱：z4t155664@163.com。
