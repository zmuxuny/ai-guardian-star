...
PAIRS = [
    ...
    # 通用渐变头（GradientHeader）最亮端
    ("渐变头 标题文字", "#ffffff", "#2563eb", 4.5),
    # 蓝色胶囊标签（主题设置 / AI 权限 / 保留天数 / AiChat 快捷问句）
    ("胶囊标签 浅色", "#1d4ed8", "#eff6ff", 4.5),
    ("胶囊标签 暗色", "#93c5fd", "#1e3a5f", 4.5),
    # 其余按钮与占位文字
    ("AiChat 发送键 禁用态", "#ffffff", "#64748b", 4.5),
    ("mainpage 摄像头未连接 浅色", "#cbd5e1", "#1e293b", 4.5),
    ("mainpage 摄像头未连接 暗色", "#cbd5e1", "#1a2744", 4.5),
    ("Index 不同意按钮", "#475569", "#f1f5f9", 4.5),
    ("person 注销弹窗 取消按钮", "#475569", "#f1f5f9", 4.5),
    ("MyAddress 添加地址按钮 渐变亮端", "#ffffff", "#2563eb", 4.5),
    ("保存中按钮（Profile / MyAddress）", "#ffffff", "#64748b", 4.5),
]
